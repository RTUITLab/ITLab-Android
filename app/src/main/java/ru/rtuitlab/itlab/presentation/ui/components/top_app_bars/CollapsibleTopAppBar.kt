 ...
 *
 * Use [CollapsibleTopAppBar] as you would any other AppBar, but provide it with a [ru.rtuitlab.itlab.presentation.ui.components.SearchBar] and a [SwipeableState] of [SwipingStates]
 *
 * Your last(!) scrollable child must be [CollapsibleScrollArea], also having access to a [SwipeableState]
 * @sample ru.rtuitlab.itlab.presentation.screens.events.Events
